...
default_cfgs.logs.checkpoint.path = "logs/atari/PongNoFrameskip-v4/dueling_dqn/checkpoints"
                                                 # Path to the checkpoint
default_cfgs.logs.checkpoint.name = "checkpoint.pth"
                                                 # Checkpoint name
default_cfgs.logs.video = edict()
default_cfgs.logs.video.path = "logs/atari/PongNoFrameskip-v4/dueling_dqn/videos"
                                                 # Path to the videos
default_cfgs.logs.video.freq = 50                # Video frequency
default_cfgs.logs.print = edict()
default_cfgs.logs.print.path = "logs/atari/PongNoFrameskip-v4/dueling_dqn/records"
                                                 # Path to the records
